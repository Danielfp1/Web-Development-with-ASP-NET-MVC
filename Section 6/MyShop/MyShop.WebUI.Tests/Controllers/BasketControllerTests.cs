...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "danielfp.pc@hotmail.com", ZipCode = "76450-000" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("danielfp.pc@hotmail.com", "Forms"), null);
